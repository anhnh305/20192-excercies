...
{
  ACE_UNUSED_ARG(ser);
  return ser.skip(static_cast<ACE_UINT16>(12), 1);
}
...
{
  ACE_UNUSED_ARG(ser);
  return ser.skip(static_cast<ACE_UINT16>(3), 1);
}
...
struct MetaStructImpl<OpenDDS::DCPS::EntityId_t> : MetaStruct {
  ...
  {
    if (!gen_skip_over(ser, static_cast<OpenDDS::DCPS::EntityKey_t_forany*>(0))) {
